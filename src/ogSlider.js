  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          {thumbMode === 1 || thumbMode === 0 ? this.renderThumbSides('left', isSmall, thumbTintColor) : null }
          <View
            style={{
          ...
          />
          {thumbMode === -1 || thumbMode === 0 ? this.renderThumbSides('right', isSmall, thumbTintColor) : null }
        </Animated.View>
        <View
          renderToHardwareTextureAndroid
